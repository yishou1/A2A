...
def main():
    parser = argparse.ArgumentParser(description="SynapseRAG Ablation Study - MROAW & Agentic PPR")
    ...
    # === MROAW and Agentic PPR parameters for Ablation Study ===
    parser.add_argument('--edge_weight_mode', type=str, default='base',
                        choices=['uniform', 'base', 'heuristic_mroaw', 'probabilistic_mroaw'],
                        help="Edge weight strategy: 'uniform' (all=1), 'base' (raw stats), 'heuristic_mroaw' (linear), 'probabilistic_mroaw' (Bayesian)")
    parser.add_argument('--use_agentic_ppr_reset', type=str, default='true',
                        help='Enable agentic PPR reset (softmax + topP). Set to false for legacy baseline.')
    parser.add_argument('--mroaw_use_info_likelihood', type=str, default='true',
                        help='Whether to use information likelihood (entity rarity) in MROAW.')
    parser.add_argument('--mroaw_use_struct_likelihood', type=str, default='true',
                        help='Whether to use structural likelihood (path support) in MROAW.')
    parser.add_argument('--mroaw_use_semantic_likelihood', type=str, default='true',
                        help='Whether to use semantic likelihood (embedding similarity) in MROAW.')
    ...
    # Convert MROAW and Agentic PPR parameters
    use_agentic_ppr_reset = string_to_bool(args.use_agentic_ppr_reset)
    mroaw_use_info_likelihood = string_to_bool(args.mroaw_use_info_likelihood)
    mroaw_use_struct_likelihood = string_to_bool(args.mroaw_use_struct_likelihood)
    mroaw_use_semantic_likelihood = string_to_bool(args.mroaw_use_semantic_likelihood)
    ...
    config = BaseConfig(
        ...
        use_agentic_ppr_reset=use_agentic_ppr_reset,
        mroaw_use_info_likelihood=mroaw_use_info_likelihood,
        mroaw_use_struct_likelihood=mroaw_use_struct_likelihood,
        mroaw_use_semantic_likelihood=mroaw_use_semantic_likelihood,
    )
