...
def main():
    ...
    save_dir = 'outputs'  # Define save directory for SynapseRAG objects (each LLM/Embedding model combination will create a new subdirectory)
    ...
    logger.info("Writing demo logs to %s", log_path)
    ...
    logger.info("Demo QA results: %s", results)
