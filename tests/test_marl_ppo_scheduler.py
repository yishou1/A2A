...
class MARLPPOSchedulerTest(unittest.TestCase):
    def setUp(self):
        self._env_patch = mock.patch.dict(
            os.environ, {"TIA_EXECUTION_MODE": "in_process"}, clear=False
        )
    ...
    def test_perception_skill_delegates_task_schedule(self):
        ...
        self.assertNotIn("MARL-PPO-Task-Scheduler", out.algorithm_trace)
