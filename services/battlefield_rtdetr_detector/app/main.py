...
from a2a_algorithms_common.tia_predictors import predict_battlefield_rtdetr_detector, tia_model_loaded
...
def _predict(inputs: dict, params: dict) -> dict:
    return predict_battlefield_rtdetr_detector(inputs, params)
