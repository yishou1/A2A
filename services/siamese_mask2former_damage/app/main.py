...
from a2a_algorithms_common.tia_predictors import predict_siamese_mask2former_damage, tia_model_loaded
...
def _predict(inputs: dict, params: dict) -> dict:
    return predict_siamese_mask2former_damage(inputs, params)
