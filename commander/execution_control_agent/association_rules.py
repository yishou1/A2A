...
def load_training_records(path: Path | None = None) -> List[dict]:
    records_path = path or (_project_root() / "data" / "execution_control" / "fixtures" / "rule_training_records.json")
...
def load_or_mine_rules(
    *,
    ...
    rules_path = rules_path or (_project_root() / "data" / "execution_control" / "processed" / "mined_rules.json")
