...
def build_air_space_sea_carrier_strike_scenario() -> dict[str, Any]:
    ...
    return {
        ...
        "demo_checkpoints": [
            ...
            {"checkpoint_id": "ASC-CP-CLOSE", "title": "双目标效果确认与分批回收完成", "min_elapsed_sec": 5850, "conditions": {"media_ids_released": ["ASC-MEDIA-09"], "weapon_hit_target_ids": ["COASTAL-AIRFIELD-01", "MOBILE-COASTAL-AD-01"]}, "pause": True, "submit_analysis": True, "block_until_analysis_complete": False, "requires_operator_action": True, "operator_action_type": "review"},
        ],
